...
function App() {
  ...
  <Container>
    <Navbar.Brand href="#home">EComerce-App</Navbar.Brand>
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="me-auto">
        ...
        <NavDropdown title="Dropdown" id="basic-nav-dropdown">
          <NavDropdown.Item href="#action/3.1">Offices</NavDropdown.Item>
